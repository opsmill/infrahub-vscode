...
- **"TLS Certificate expired - check <!-- vale off -->tls_insecure<!-- vale on -->ure setting"**: The server's certificate has expired
- **"Self-signed certificate - check <!-- vale off -->tls_insecure<!-- vale on -->ure setting"**: The server uses a self-signed certificate
- **"TLS Verification failed - check <!-- vale off -->tls_insecure<!-- vale on -->ure setting"**: General certificate verification failure
