...
| CERT_HAS_EXPIRED | Expired SSL certificate | Renew certificate or use `<!-- vale off -->tls_insecure<!-- vale on -->` for dev |
| SELF_SIGNED_CERT_IN_CHAIN | Self-signed certificate | Use `"<!-- vale off -->tls_insecure<!-- vale on -->": true` for development |
...
- [How to Visualize Your Schema](../guides/visualize-schema.mdx)
